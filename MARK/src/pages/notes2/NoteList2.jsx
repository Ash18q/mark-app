...
import NoteCard2 from './NoteCard2'

export default function NoteList2({
  notes,
  viewMode,
  onEdit,
  onDelete,
  ...
  if (notes.length === 0) {
    return (
      <div className="text-center py-16 px-4 bg-white rounded-3xl border border-slate-100 shadow-sm">
        ...
        <h3 className="text-base font-bold text-slate-800 mb-1">No notes in Notes 2</h3>
        <p className="text-xs text-slate-500 max-w-xs mx-auto mb-4 leading-relaxed">
          Create your first sticky note or checklist to get started.
        </p>
      </div>
    )
  }

      ...
      <div className="pt-2.5 border-t border-black/5 flex items-center justify-between text-[11px]">
        ...
        <div className="flex items-center gap-1.5 opacity-90 group-hover:opacity-100 transition">
          ...
          <button
            ...
            className="p-1 rounded-lg hover:bg-black/10 text-slate-900 transition cursor-pointer"
          ...
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 8h14M5 8a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H7a2 2 0 01-2-2V8zm3 4h6" />
            </svg>
          </button>
          ...
          <button
            ...
            className="p-1 rounded-lg hover:bg-red-50 text-red-500 hover:text-red-600 transition cursor-pointer"
            title="Delete Note"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
